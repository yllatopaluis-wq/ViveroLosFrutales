...
public class Empresa : AuditableEntity
{
    ...
    public string RepresentanteLegalCargo { get; set; } = string.Empty;
    public byte[]? FirmaContenido { get; set; }
    public string FirmaContentType { get; set; } = string.Empty;
    public string FirmaNombre { get; set; } = string.Empty;
